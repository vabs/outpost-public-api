# -*- coding: utf-8 -*-
#
# Outpost API documentation build configuration file, created by
...
project = u'OutpostTravel API'
copyright = u'2014, Outpost Travel Inc'
...
htmlhelp_basename = 'OutpostAPIdoc'
